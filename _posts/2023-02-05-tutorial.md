...
### Getting Started
 ...
 The command line interface, or the language you type into Terminal to ineract with your Mac, is called bash. The commands we will discuss below are bash commands. 
