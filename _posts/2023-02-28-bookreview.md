...
One of the only things I didn't love about the book was that it provided a lot of anecdotal evidence and didn't provide a lot of in-depth analysis of the underlying causes of the gender data gap. I would have liked to read more about why we think the way that we do and why it seems to have always been like that, in addition to how that thinking affects our lives daily.
